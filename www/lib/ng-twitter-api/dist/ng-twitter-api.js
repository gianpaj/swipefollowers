...
.factory('$twitterApi', ['$q', '$twitterHelpers', '$http', function($q, $twitterHelpers, $http) {
  ...
  var USER_FRIENDS_URL = 'https://api.twitter.com/1.1/friends/list.json';
  ...
  return {
    ...
    getUserDetails: function(screen_name, parameters) {
      return getRequest(USER_DETAILS_URL, {screen_name: screen_name}, parameters);
    },
    getUserFollowers: function(screen_name, parameters) {
      return getRequest(USER_FRIENDS_URL, {screen_name: screen_name}, parameters);
    },
  ...
  */
  function createSignature(method, endPoint, headerParameters, bodyParameters, secretKey, tokenSecret) {
    if (typeof jsSHA !== 'undefined') {
      ...
      var oauthSignatureObject = new jsSHA(signatureBaseString, 'TEXT'); // eslint-disable-line new-cap
